...
LABEL version="6.5", os="centos7(latest)", java="serverjre:8 (oracle)", aemversion="6.5", aem-type="author", aem-properties-folder="/opt/aem-config", aem-logs="/opt/aem/crx-quickstart/logs"
...
ENV container "aem-6.5-quickstart,aem-author,centos,java8"
...
CMD /bin/bash -c "cp -v /opt/aem-config/* /opt/aem; cd /opt/aem/ ;  java -Xms1024m -Xmx2048m -jar ./AEM_6.5_Quickstart.jar -v -r author,crx3 -p 4040 -Dadmin.password.file=./admin.password.file -nointeractive -nobrowser"
